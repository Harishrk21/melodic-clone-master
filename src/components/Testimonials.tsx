  ...
  const testimonials = [
    {
      ...
      role: "Guitar Student",
      content:
        "The instructors are incredibly patient and skilled. I've learned more in 3 months here than I did in a year of self-learning!",
      rating: 5,
    },
    {
      name: "Rahul Mehta",
      role: "Piano Student",
      content:
        "Flexible scheduling and personalized attention made all the difference. My son loves his piano classes!",
      rating: 5,
    },
    {
      name: "Anjali Reddy",
      role: "Vocal Student",
      content:
        "Preparing for my Trinity grade exam has been smooth thanks to the structured curriculum and expert guidance.",
      rating: 5,
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 animate-slide-up">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Join our growing community of passionate learners at{" "}
