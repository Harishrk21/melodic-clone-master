  ...
  const guitarTypes = [
    {
      ...
      description: "Perfect for beginners and versatile across genres. The warm, natural sound of acoustic guitars makes them ideal for folk, pop, and singer-songwriter styles.",
      features: ["Steel or nylon strings", "Natural resonance", "No amplification needed", "Great for beginners"],
      image: "https://images.unsplash.com/photo-1516924962500-2b4b3b99ea02?w=600&h=400&fit=crop"
    },
    {
      id: "electric",
      name: "Electric Guitar",
      description: "The heart of rock, metal, and modern music. Electric guitars offer endless tonal possibilities through effects and amplification.",
      features: ["Solid body construction", "Multiple pickup configurations", "Effects compatibility", "Ideal for rock & metal"],
      image: "https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?w=600&h=400&fit=crop"
    },
    {
      id: "classical",
      name: "Classical Guitar",
      description: "Traditional elegance with nylon strings. Perfect for classical music, flamenco, and players seeking a softer, mellower tone.",
      features: ["Nylon strings", "Wider neck", "Classical repertoire", "Gentle on fingers"],
      image: "https://images.unsplash.com/photo-1510915228340-29c85a43dcfe?w=600&h=400&fit=crop"
    },
    {
      id: "bass",
      name: "Bass Guitar",
      description: "The foundation of rhythm. Bass guitars provide the low-end groove that drives the entire band forward.",
      features: ["4-6 strings", "Lower register", "Rhythm foundation", "Band essential"],
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                  Master the <span className="text-yellow-400">Guitar</span>
                </h1>
